...
const Contact = () => {
  ...
  return (
    <section id="contact" className="bg-ds-gray py-16 md:py-24">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:sammraya98@gmail.com" className="text-accent hover:underline">sammraya98@gmail.com</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-foreground/80">Nairobi Moi Avenue, Kenya</p>
                </div>
              </div>
